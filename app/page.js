...
Bravo pour ton travail ! 💪`,
  ...
  if (!matiere) {
    return (
      <div className="min-h-[100dvh] bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 p-4 sm:p-6">
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-blue-50 to-purple-50 pb-32 sm:pb-40">
      {showCelebration && (
        <div className="fixed inset-0 pointer-events-none z-50 flex items-center justify-center">
          <div className="bg-white rounded-3xl shadow-2xl p-8 animate-bounce">
            <Sparkles className="w-16 h-16 text-yellow-400 mx-auto mb-4" />
